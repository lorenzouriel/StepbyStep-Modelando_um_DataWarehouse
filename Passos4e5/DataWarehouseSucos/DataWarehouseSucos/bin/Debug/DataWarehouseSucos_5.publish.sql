...
:setvar DefaultDataPath "C:\Program Files\Microsoft SQL Server\MSSQL15.GEOSIGA\MSSQL\DATA\"
:setvar DefaultLogPath "C:\Program Files\Microsoft SQL Server\MSSQL15.GEOSIGA\MSSQL\DATA\"
...
GO
PRINT N'Rename refactoring operation with key dc53946b-fea5-4751-808e-af19dbf46a7f is skipped, element [dbo].[Fato_001].[Cod_Dia] (SqlSimpleColumn) will not be renamed to Cod_Fabrica';


GO
PRINT N'Rename refactoring operation with key 524a0b69-1052-4d4f-91d7-1b00abca5cd4 is skipped, element [dbo].[Fato_001].[Id] (SqlSimpleColumn) will not be renamed to Cod_Cliente';


GO
PRINT N'Rename refactoring operation with key 4e6cb439-0bd5-4eb6-bf4f-c031a6f14001 is skipped, element [dbo].[Fato_001].[Faturamento] (SqlSimpleColumn) will not be renamed to Cod_Dia';
